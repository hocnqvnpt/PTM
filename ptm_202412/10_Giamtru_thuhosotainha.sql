...
select sum(tien_giam) from ttkd_bsc.ct_giamtru where thang = 202412 --86670000
;
delete from ttkd_bsc.ct_giamtru where thang=202412
;
insert into ttkd_bsc.ct_giamtru (ma_gd, thang, tien_giam, nguon_giam, ly_do, ma_nv, ma_to, ma_pb)
		    select ma_gd, thang_tldg_dt thang, 15000 tien_giam, 'Luong don gia' nguon_giam
			   ...
			   where kieuhd_id = 2 and thang_tldg_dt = 202412 
