...
--		  select * from ttkd_bsc.dinhmuc_giao_dthu_ptm a
	...
	where thang = 202412 and ma_vtcv  in ('VNP-HNHCM_KHDN_3.1', 'VNP-HNHCM_KHDN_18', 'VNP-HNHCM_KHDN_3') 
						and ma_pb in (
											'VNP0702300',
											'VNP0702400',
											'VNP0702500'
...
--					and ten_to like '%Tr? Tr??c%'
	...
	select * from ttkd_bsc.dinhmuc_giao_dthu_ptm a
	where thang = 202412 
				and exists (select 1 from ttkd_bsc.blkpi_danhmuc_kpi_vtcv where thang = 202412 and ma_kpi = 'HCM_DT_PTMOI_021' and  a.ma_vtcv = ma_vtcv)
...
;
drop table ttkd_bsc.x_dinhmuc_giao_dthu_ptm_202412;
create table ttkd_bsc.x_dinhmuc_giao_dthu_ptm_202412 as select * from
	ttkd_bsc.dinhmuc_giao_dthu_ptm
	where thang = 202412
	;
select * from
	ttkd_bsc.bangluong_kpi
	where thang = 202412 and ma_kpi in ('HCM_TB_GIAHA_024', 'HCM_TB_GIAHA_026')
