...
drop table ttkd_bsc.ct_bsc_ptm_potmasco_202403;

select * from ttkd_bsc.ct_bsc_ptm_potmasco_202403;
select distinct TENKIEU_LD from ttkd_bsc.ct_bsc_ptm_potmasco_202403;
            
		  create table ttkd_bsc.ct_bsc_ptm_potmasco_202403 as
                select * from ttkd_bsc.ct_bsc_ptm
                where 
							(manv_ptm in (select ma_nv from ttkd_bsc.nhanvien_vttp_potmasco where thang = 202403)
								or manv_hotro in (select ma_nv from ttkd_bsc.nhanvien_vttp_potmasco where thang = 202403)
							)
                                and ((thang_ptm between 202312 and 202403     ---thang n-3
										  and ((loaihd_id=1 and loaitb_id in (11,58,61)) or loaitb_id=20)
										  and (thang_tldg_dt = 202403 or thang_tldg_dt is null))          ---thang n
                                            or (loaitb_id=21 and thang_ptm = 202403))                       ---thang n
    ;
...
select * from ttkd_bsc.nhanvien_vttp_potmasco where thang = 202403;
select * from  ttkd_bsc.bangluong_dongia_potmasco where thang = 202403;
...
insert into ttkd_bsc.bangluong_dongia_potmasco
      (ma_nv,ten_nv,ma_vtcv,ten_vtcv,ma_pb,ten_pb,ma_to,ten_to, thang )
		SELECT ma_nv,ten_nv,ma_vtcv,ten_vtcv,ma_pb,ten_pb,ma_to,ten_to, thang           --thang n
		  ...
		  where thang = 202403
--					exists(select 1 from ttkd_bsc.ct_bsc_ptm_202403_vttp where manv_ptm=a.ma_nv)
...
-- tong hop:  
		...
		;
					...
					select manv_ptm ma_nv, 
							  (select ten_pb from ttkd_bsc.nhanvien_vttp_potmasco where thang = 202403 and ma_nv = a.manv_ptm) ten_donvi,            
					...
					(
					    ...
					    from ttkd_bsc.ct_bsc_ptm_potmasco_202403
					    where thang_tldg_dt = 202403 and loaitb_id != 21          ---thang n---
					    ...
					    union all
							    ...
							    from ttkd_bsc.ct_bsc_ptm_potmasco_202403
							    where thang_tldg_dt_nvhotro = 202403 and loaitb_id != 21          ---thang n---
					   ...
					   union all 
					    ...
					    -- select *  
					    from ttkd_bsc.ct_bsc_ptm_potmasco_202403
					    where loaitb_id = 21 and thang_ptm = 202403 and thang_tldg_dt = 202403              --thang n
					    group by manv_ptm  
					    ...
					    -- select *
					    from ttkd_bsc.ct_bsc_ptm_potmasco_202403
					    where thang_tldg_dnhm = 202403      ----thang n
									and manv_ptm is not null
					    group by manv_ptm 
					) a
...
update ttkd_bsc.bangluong_dongia_potmasco set tong_dt_chitl='', tong_tl='' , tong_dt_chuachitl='',  tong_sl_chitl='', tong_sl_chuachitl='' where thang = 202403
;
			update ttkd_bsc.bangluong_dongia_potmasco a
...
update ttkd_bsc.bangluong_dongia_potmasco set dt_brcd_chitl='' where dt_brcd_chitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set dt_mytv_chitl='' where dt_mytv_chitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set dt_vnpts_chitl='' where dt_vnpts_chitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set dt_vnptt_chitl='' where dt_vnptt_chitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set tong_dt_chitl='' where tong_dt_chitl=0 and thang = 202403;

update ttkd_bsc.bangluong_dongia_potmasco set tl_brcd='' where tl_brcd=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set tl_mytv='' where tl_mytv=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set tl_vnpts='' where tl_vnpts=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set tl_vnptt='' where tl_vnptt=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set tong_tl='' where tong_tl=0 and thang = 202403;
            
update ttkd_bsc.bangluong_dongia_potmasco set dt_brcd_chuachitl='' where dt_brcd_chuachitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set dt_mytv_chuachitl='' where dt_mytv_chuachitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set dt_vnpts_chuachitl='' where dt_vnpts_chuachitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set dt_vnptt_chuachitl='' where dt_vnptt_chuachitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set tong_dt_chuachitl='' where tong_dt_chuachitl=0 and thang = 202403;
            
update ttkd_bsc.bangluong_dongia_potmasco set sl_brcd_chitl='' where sl_brcd_chitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set sl_mytv_chitl='' where sl_mytv_chitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set sl_vnpts_chitl='' where sl_vnpts_chitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set sl_vnptt_chitl='' where sl_vnptt_chitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set tong_sl_chitl='' where tong_sl_chitl=0 and thang = 202403;

update ttkd_bsc.bangluong_dongia_potmasco set sl_brcd_chuachitl='' where sl_brcd_chuachitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set sl_mytv_chuachitl='' where sl_mytv_chuachitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set sl_vnpts_chuachitl='' where sl_vnpts_chuachitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set sl_vnptt_chuachitl='' where sl_vnptt_chuachitl=0 and thang = 202403;
update ttkd_bsc.bangluong_dongia_potmasco set tong_sl_chuachitl='' where tong_sl_chuachitl=0 and thang = 202403;
...
-- Thu hoi:
				update ttkd_bsc.bangluong_dongia_potmasco a  
				   ...
				   where tong_tl_thuhoi is not null
								and thang = 202403
				   ;
--   select * from ttkd_bsc.bangluong_dongia_202403_vttp a
				update ttkd_bsc.bangluong_dongia_potmasco a  
				   set (tl_thuhoi_brcd, tl_thuhoi_mytv, tl_thuhoi_vnpts, tl_thuhoi_vnptt, tong_tl_thuhoi, sl_thuhoi_brcd, sl_thuhoi_mytv, sl_thuhoi_vnpts, sl_thuhoi_vnptt, tong_sl_thuhoi) 
							 = (select sum(case when loaitb_id =58 then tien_thuhoi end)
								  ...
								  where thang = 202403 and ma_nv = a.ma_nv)             ---thang n
--				  select * from ttkd_bsc.bangluong_dongia_potmasco a  
...
--			 sum(tl_thuhoi_vnptt) tl_thuhoi_vnptt,
--			 sum(tong_tl_thuhoi) tong_tl_thuhoi
from ttkd_bsc.bangluong_dongia_202403_vttp
...
-- File excel chitiet_tbao_thulao_thuhoi_XXyyyy: (bao gom da tinh, chua tinh và thu hoi) 
	select *
	from(
				select 'PTM' nguon, thang_ptm
					    ...
					    , (case when thang_tldg_dnhm = 202403 then doanhthu_dongia_dnhm else 0 end) -- dt_dongia_dnhm
							+ (case when thang_tldg_dt = 202403 then doanhthu_dongia_nvptm else 0 end) --dt_dongia_goi
							as tong_dt_dongia_goi
						, (case when thang_tldg_dnhm = 202403 then luong_dongia_dnhm_nvptm else 0 end)  --tl_dnhm
							+ (case when thang_tldg_dt = 202403 then luong_dongia_nvptm else 0 end) --tl_goi
							as tong_tl_goi
--				 select * 
				from ttkd_bsc.ct_bsc_ptm_potmasco_202403 a
							join ttkd_bsc.nhanvien_vttp_potmasco b on b.thang = 202403 and a.manv_ptm = b.ma_nv     --thang n
...
--				 select * 
				from ttkd_bsc.ct_bsc_ptm_potmasco_202403 a
							join ttkd_bsc.nhanvien_vttp_potmasco b on b.thang = 202403 and a.manv_hotro = b.ma_nv     --thang n
				where loaitb_id in (58, 61, 20, 11)
				...
				select 'PTM' nguon, thang_ptm
					    ...
					    , a.manv_ptm, b.ten_nv, b.ma_to, b.ten_to, b.ma_pb, b.ten_pb
						 , (case when thang_tldg_dnhm = 202403 then tien_dnhm else 0 end) -- dt_dongia_dnhm
							+ (case when thang_tldg_dt = 202403 then dthu_goi_goc else 0 end) --dt_dongia_goi
							as tong_dt_dongia_goi
						, (case when thang_tldg_dnhm = 202403 then luong_dongia_dnhm_nvptm else 0 end)  --tl_dnhm
							+ (case when thang_tldg_dt = 202403 then luong_dongia_nvptm else 0 end) --tl_goi
							as tong_tl_goi
...
-- CT_THUHOI
		select 'Thuhoi' nguon, cast(thang_ptm as number) thang
		 ...
		 where a.thang = 202403 and a.loaitb_id in (58, 61, 20, 21) 
		--   and exists(select * from ttkd_bsc.bangluong_dongia_202403_vttp where ma_nv=a.ma_nv)
   ;

select * from  ttkd_bsc.ct_thuhoi
;
select ma_nv, count(ma_to) from ttkd_bsc.ct_bsc_ptm_202403_vttp where thang=202403 
group by ma_nv;
...
ttkd_bsc.bangluong_dongia_202403_vttp_postmaco;
ttkd_bsc.ct_bsc_ptm_202403_vttp_postmaco
