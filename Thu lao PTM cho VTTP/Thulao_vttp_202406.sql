...
drop table ttkd_bsc.ct_bsc_ptm_202406_vttp;

select * from ttkd_bsc.ct_bsc_ptm_202406_vttp;
select distinct TENKIEU_LD from ttkd_bsc.ct_bsc_ptm_202406_vttp;
            
		  create table ttkd_bsc.ct_bsc_ptm_202406_vttp as
                select * from ttkd_bsc.ct_bsc_ptm
                where 
							(manv_ptm in (select ma_nv from ttkd_bsc.nhanvien where thang = 202406 and donvi = 'VTTP')
								or manv_hotro in (select ma_nv from ttkd_bsc.nhanvien where thang = 202406 and donvi = 'VTTP')
							)
                                and ((thang_ptm >= 202403     ---thang n-3
										  ...
										  and (thang_tldg_dt = 202406 or thang_tldg_dt is null))          ---thang n
                                            or (loaitb_id=21 and thang_ptm = 202406))                       ---thang n
    ;
    

                    
-- Tao bangluong_dongia_202402_vttp
drop table ttkd_bsc.bangluong_dongia_202406_vttp;
...
select * from ttkd_bsc.nhanvien where donvi = 'VTTP' and thang = 202406;
select * from ttkd_bsc.nhanvien_vttp where thang = 202406;
select * from  ttkd_bsc.bangluong_dongia_vttp where thang = 202406;
...
insert into ttkd_bsc.bangluong_dongia_vttp
      (ma_nv,ten_nv,ma_vtcv,ten_vtcv,ma_pb,ten_pb,ma_to,ten_to,thang )
		SELECT ma_nv,ten_nv,ma_vtcv,ten_vtcv,ma_pb,ten_pb,ma_to,ten_to, thang           --thang n
		  ...
		  where donvi = 'VTTP' and thang = 202406
...
-- tong hop:  
		...
		;
					...
					select manv_ptm ma_nv, 
							  (select ten_pb from ttkd_bsc.nhanvien where donvi = 'VTTP' and thang = 202406 and ma_nv = a.manv_ptm) ten_donvi,            
					...
					(
					    ...
					    from ttkd_bsc.ct_bsc_ptm_202406_vttp
...
;
					...
					select manv_ptm ma_nv, 
							  (select ten_pb from ttkd_bsc.nhanvien_vttp where thang = 202406 and ma_nv=a.manv_ptm) ten_donvi,
...
update ttkd_bsc.bangluong_dongia_vttp set tong_dt_chitl='', tong_tl='' , tong_dt_chuachitl='',  tong_sl_chitl='', tong_sl_chuachitl='' where thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp a
...
update ttkd_bsc.bangluong_dongia_vttp set dt_brcd_chitl='' where dt_brcd_chitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set dt_mytv_chitl='' where dt_mytv_chitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set dt_vnpts_chitl='' where dt_vnpts_chitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set dt_vnptt_chitl='' where dt_vnptt_chitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set tong_dt_chitl='' where tong_dt_chitl=0 and thang = 202406;

update ttkd_bsc.bangluong_dongia_vttp set tl_brcd='' where tl_brcd=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set tl_mytv='' where tl_mytv=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set tl_vnpts='' where tl_vnpts=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set tl_vnptt='' where tl_vnptt=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set tong_tl='' where tong_tl=0 and thang = 202406;
            
update ttkd_bsc.bangluong_dongia_vttp set dt_brcd_chuachitl='' where dt_brcd_chuachitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set dt_mytv_chuachitl='' where dt_mytv_chuachitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set dt_vnpts_chuachitl='' where dt_vnpts_chuachitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set dt_vnptt_chuachitl='' where dt_vnptt_chuachitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set tong_dt_chuachitl='' where tong_dt_chuachitl=0 and thang = 202406;
            
update ttkd_bsc.bangluong_dongia_vttp set sl_brcd_chitl='' where sl_brcd_chitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set sl_mytv_chitl='' where sl_mytv_chitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set sl_vnpts_chitl='' where sl_vnpts_chitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set sl_vnptt_chitl='' where sl_vnptt_chitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set tong_sl_chitl='' where tong_sl_chitl=0 and thang = 202406;

update ttkd_bsc.bangluong_dongia_vttp set sl_brcd_chuachitl='' where sl_brcd_chuachitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set sl_mytv_chuachitl='' where sl_mytv_chuachitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set sl_vnpts_chuachitl='' where sl_vnpts_chuachitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set sl_vnptt_chuachitl='' where sl_vnptt_chuachitl=0 and thang = 202406;
update ttkd_bsc.bangluong_dongia_vttp set tong_sl_chuachitl='' where tong_sl_chuachitl=0 and thang = 202406;
...
--   select * from ttkd_bsc.bangluong_dongia_202406_vttp a
			...
			delete from ttkd_bsc.bangluong_dongia_vttp
...
--				         thang_tldg_dt thang_chi,
						...
						, (case when thang_tldg_dnhm='202406' then luong_dongia_dnhm_nvptm else 0 end)  --tl_dnhm
							...
							as tong_tl_goi
				-- select * 
				from ttkd_bsc.ct_bsc_ptm_202406_vttp a
							join ttkd_bsc.nhanvien b on b.thang = 202406 and donvi = 'VTTP' and a.manv_ptm = b.ma_nv     --thang n
