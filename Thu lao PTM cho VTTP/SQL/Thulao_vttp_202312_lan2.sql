-- Kiem tra
select distinct lydo_khongtinh_dongia from ct_bsc_ptm
where nhom_tiepthi=2 and thang_ptm>=202309  
    and ungdung_id=17 and thang_tldg_dt is null;
    
-- Chi tiet trong ky:      
drop table ct_bsc_ptm_202312_vttp_lan2;
create table ct_bsc_ptm_202312_vttp_lan2 as
    select * from ct_bsc_ptm
    where nhom_tiepthi=2 
            and ((thang_ptm>=202309  
...
-- Tao bangluong_dongia_202312_vttp_29012024
drop table bangluong_dongia_202312_vttp_29012024;
create table bangluong_dongia_202312_vttp_29012024 (
ma_nv               varchar(10),
ten_nv               varchar(50),
ma_vtcv            varchar(20),
...
insert into bangluong_dongia_202312_vttp_29012024
...
SELECT ma_nv,ten_nv,ma_vtcv,ten_vtcv,ma_pb,ten_pb,ma_to,ten_to,202312
  ...
  where exists(select 1 from ct_bsc_ptm_202312_vttp_lan2 where manv_ptm=a.ma_nv)
...
(
    ...
    from ct_bsc_ptm_202312_vttp_lan2
...
-- ptm cdbr + gtgt +vnpts             
update bangluong_dongia_202312_vttp_29012024 a
      set 
            sl_brcd_chitl='',
            sl_mytv_chitl='',
            sl_vnpts_chitl='',
...
update bangluong_dongia_202312_vttp_29012024 a
           ...
           =(select sl_brcd_chitl, sl_mytv_chitl, sl_vnpts_chitl, sl_vnptt_chitl, 
             ...
             where ma_nv=a.ma_nv)
    -- select * from bangluong_dongia_202312_vttp_29012024 a
...
-- Tong:
update bangluong_dongia_202312_vttp_29012024 set tong_dt_chitl='', tong_tl='' , tong_dt_chuachitl='',  tong_sl_chitl='', tong_sl_chuachitl='';
update bangluong_dongia_202312_vttp_29012024 a
...
update bangluong_dongia_202312_vttp_29012024 set dt_brcd_chitl='' where dt_brcd_chitl=0;
update bangluong_dongia_202312_vttp_29012024 set dt_mytv_chitl='' where dt_mytv_chitl=0;
update bangluong_dongia_202312_vttp_29012024 set dt_vnpts_chitl='' where dt_vnpts_chitl=0;
update bangluong_dongia_202312_vttp_29012024 set dt_vnptt_chitl='' where dt_vnptt_chitl=0;
update bangluong_dongia_202312_vttp_29012024 set tong_dt_chitl='' where tong_dt_chitl=0;

update bangluong_dongia_202312_vttp_29012024 set tl_brcd='' where tl_brcd=0;
update bangluong_dongia_202312_vttp_29012024 set tl_mytv='' where tl_mytv=0;
update bangluong_dongia_202312_vttp_29012024 set tl_vnpts='' where tl_vnpts=0;
update bangluong_dongia_202312_vttp_29012024 set tl_vnptt='' where tl_vnptt=0;
update bangluong_dongia_202312_vttp_29012024 set tong_tl='' where tong_tl=0;
            
update bangluong_dongia_202312_vttp_29012024 set dt_brcd_chuachitl='' where dt_brcd_chuachitl=0;
update bangluong_dongia_202312_vttp_29012024 set dt_mytv_chuachitl='' where dt_mytv_chuachitl=0;
update bangluong_dongia_202312_vttp_29012024 set dt_vnpts_chuachitl='' where dt_vnpts_chuachitl=0;
update bangluong_dongia_202312_vttp_29012024 set dt_vnptt_chuachitl='' where dt_vnptt_chuachitl=0;
update bangluong_dongia_202312_vttp_29012024 set tong_dt_chuachitl='' where tong_dt_chuachitl=0;
            
update bangluong_dongia_202312_vttp_29012024 set sl_brcd_chitl='' where sl_brcd_chitl=0;
update bangluong_dongia_202312_vttp_29012024 set sl_mytv_chitl='' where sl_mytv_chitl=0;
update bangluong_dongia_202312_vttp_29012024 set sl_vnpts_chitl='' where sl_vnpts_chitl=0;
update bangluong_dongia_202312_vttp_29012024 set sl_vnptt_chitl='' where sl_vnptt_chitl=0;
update bangluong_dongia_202312_vttp_29012024 set tong_sl_chitl='' where tong_sl_chitl=0;

update bangluong_dongia_202312_vttp_29012024 set sl_brcd_chuachitl='' where sl_brcd_chuachitl=0;
update bangluong_dongia_202312_vttp_29012024 set sl_mytv_chuachitl='' where sl_mytv_chuachitl=0;
update bangluong_dongia_202312_vttp_29012024 set sl_vnpts_chuachitl='' where sl_vnpts_chuachitl=0;
update bangluong_dongia_202312_vttp_29012024 set sl_vnptt_chuachitl='' where sl_vnptt_chuachitl=0;
update bangluong_dongia_202312_vttp_29012024 set tong_sl_chuachitl='' where tong_sl_chuachitl=0;


delete bangluong_dongia_202312_vttp_29012024
    -- select * from bangluong_dongia_202312_vttp_29012024
    where tong_tl is null and tong_dt_chuachitl is null and tong_sl_chitl is null and tong_sl_chuachitl is null ;
    
commit;
   
    
---- Kiem tra doanh thu 440833063
select 'bangluong_dongia_202312_vttp_29012024' , sum(tl_brcd), sum(tl_mytv) , sum(tl_vnpts), sum(tl_vnptt) from bangluong_dongia_202312_vttp_29012024 
union all
...
select 'bangluong_dongia_202312_vttp_29012024_chi' , sum(tong_sl_chitl) tong_sl
 from bangluong_dongia_202312_vttp_29012024 
union all
select 'bangluong_dongia_202312_vttp_29012024_chi',  sum(tong_sl_chuachitl) tong_sl
 from bangluong_dongia_202312_vttp_29012024
union all 
select 'bangluong_dongia_202312_vttp_29012024_tong' , sum(tong_sl_chitl) + sum(tong_sl_chuachitl) tong_sl
 from bangluong_dongia_202312_vttp_29012024 
union all
select 'ct_bsc_ptm_202312_vttp_lan2', count(*) tong_sl
 from ct_bsc_ptm_202312_vttp_lan2;
...
-- select * 
from ct_bsc_ptm_202312_vttp_lan2 a, (select * from nhanvien_vttp where thang=202312) b
...
update bangluong_dongia_202312_vttp_29012024 a  
   set (dtptm_dongia_cdbr_thuhoi, dtptm_dongia_vnpts_thuhoi, dtptm_dongia_vnptt_thuhoi, dtptm_dongia_khac_thuhoi)=
    ...
    -- select dtptm_dongia_cdbr_thuhoi, dtptm_dongia_vnpts_thuhoi, dtptm_dongia_vnptt_thuhoi, dtptm_dongia_khac_thuhoi from bangluong_dongia_202312_vttp_29012024 a
...
update bangluong_dongia_202312_vttp_29012024 a set tong_luong_thuhoi='' where tong_luong_thuhoi is not null;
update bangluong_dongia_202312_vttp_29012024 a
