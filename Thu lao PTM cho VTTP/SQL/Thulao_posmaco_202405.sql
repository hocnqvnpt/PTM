...
drop table ttkd_bsc.ct_bsc_ptm_potmasco_202405;

select * from ttkd_bsc.ct_bsc_ptm_potmasco_202405;
select distinct DICH_VU from ttkd_bsc.ct_bsc_ptm_potmasco_202405;
            
		  create table ttkd_bsc.ct_bsc_ptm_potmasco_202405 as
                select * from ttkd_bsc.ct_bsc_ptm
                where 
							(manv_ptm in (select ma_nv from ttkd_bsc.nhanvien_vttp_potmasco where thang = 202405)
								or manv_hotro in (select ma_nv from ttkd_bsc.nhanvien_vttp_potmasco where thang = 202405)
							)
                                and ((thang_ptm between 202402 and 202405     ---thang n-3
...
select * from ttkd_bsc.nhanvien_vttp_potmasco where thang = 202405;
select * from  ttkd_bsc.bangluong_dongia_potmasco where thang = 202405;
...
-- tong hop:  
		...
		;
					...
					select manv_ptm ma_nv, 
							  (select ten_pb from ttkd_bsc.nhanvien_vttp_potmasco where thang = 202405 and ma_nv = a.manv_ptm) ten_donvi,            
					...
					(
					    ...
					    from ttkd_bsc.ct_bsc_ptm_potmasco_202405
...
update ttkd_bsc.bangluong_dongia_potmasco set tong_dt_chitl='', tong_tl='' , tong_dt_chuachitl='',  tong_sl_chitl='', tong_sl_chuachitl='' where thang = 202405
;
			update ttkd_bsc.bangluong_dongia_potmasco a
...
update ttkd_bsc.bangluong_dongia_potmasco set dt_brcd_chitl='' where dt_brcd_chitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set dt_mytv_chitl='' where dt_mytv_chitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set dt_vnpts_chitl='' where dt_vnpts_chitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set dt_vnptt_chitl='' where dt_vnptt_chitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set tong_dt_chitl='' where tong_dt_chitl=0 and thang = 202405;

update ttkd_bsc.bangluong_dongia_potmasco set tl_brcd='' where tl_brcd=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set tl_mytv='' where tl_mytv=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set tl_vnpts='' where tl_vnpts=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set tl_vnptt='' where tl_vnptt=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set tong_tl='' where tong_tl=0 and thang = 202405;
            
update ttkd_bsc.bangluong_dongia_potmasco set dt_brcd_chuachitl='' where dt_brcd_chuachitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set dt_mytv_chuachitl='' where dt_mytv_chuachitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set dt_vnpts_chuachitl='' where dt_vnpts_chuachitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set dt_vnptt_chuachitl='' where dt_vnptt_chuachitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set tong_dt_chuachitl='' where tong_dt_chuachitl=0 and thang = 202405;
            
update ttkd_bsc.bangluong_dongia_potmasco set sl_brcd_chitl='' where sl_brcd_chitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set sl_mytv_chitl='' where sl_mytv_chitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set sl_vnpts_chitl='' where sl_vnpts_chitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set sl_vnptt_chitl='' where sl_vnptt_chitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set tong_sl_chitl='' where tong_sl_chitl=0 and thang = 202405;

update ttkd_bsc.bangluong_dongia_potmasco set sl_brcd_chuachitl='' where sl_brcd_chuachitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set sl_mytv_chuachitl='' where sl_mytv_chuachitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set sl_vnpts_chuachitl='' where sl_vnpts_chuachitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set sl_vnptt_chuachitl='' where sl_vnptt_chuachitl=0 and thang = 202405;
update ttkd_bsc.bangluong_dongia_potmasco set tong_sl_chuachitl='' where tong_sl_chuachitl=0 and thang = 202405;
...
-- File excel chi tiet thue bao: (bao gom da tinh, chua tinh và thu hoi)
	select *
	from(
				select 'PTM' nguon, thang_ptm
						...
						, (case when thang_tldg_dnhm = 202405 then luong_dongia_dnhm_nvptm else 0 end)  --tl_dnhm
							...
							as tong_tl_goi
--				 select * 
				from ttkd_bsc.ct_bsc_ptm_potmasco_202405 a
							join ttkd_bsc.nhanvien_vttp_potmasco b on b.thang = 202405 and a.manv_ptm = b.ma_nv     --thang n
...
--				 select * 
				from ttkd_bsc.ct_bsc_ptm_potmasco_202405 a
							join ttkd_bsc.nhanvien_vttp_potmasco b on b.thang = 202405 and a.manv_hotro = b.ma_nv     --thang n
				where loaitb_id in (58, 61, 20, 11)
