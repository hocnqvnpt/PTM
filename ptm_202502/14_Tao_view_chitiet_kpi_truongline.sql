select * from ttkd_bsc.v_ct_ptm_kpi_truongline_202502;
drop view ttkd_bsc.v_ct_ptm_kpi_truongline_202502;

CREATE OR REPLACE VIEW ttkd_bsc.v_ct_ptm_kpi_truongline_202502 as
...
--				union all ---dthu DNHM PGP không có tinh Tổ trưởng
				union all
					...
					from ttkd_bsc.ghtt_vnpts	a	----a Nguyen quan ly
					  ...
					  where thang=202502 and thang_giao is not null and a.ma_to is not null 
									and ma_nv = 'VNP031710'
