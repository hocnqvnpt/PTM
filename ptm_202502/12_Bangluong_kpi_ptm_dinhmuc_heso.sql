	update ttkd_bsc.dinhmuc_giao_dthu_ptm a set NHOMVINATS_KQTH = null, NHOMBRCD_KQTH = null, NHOMCNTT_KQTH = null, NHOMCONLAI_KQTH = null, NHOMVNPQD_KQTH = null 
...
--		  select * from ttkd_bsc.dinhmuc_giao_dthu_ptm a
			 where a.thang = 202502
							...
							and exists (select * from ttkd_bsc.blkpi_danhmuc_kpi_vtcv
												where ma_kpi in ('HCM_DT_PTMOI_021', 'HCM_DT_PTMOI_062', 'HCM_DT_PTMOI_065', 'HCM_DT_PTMOI_069') and thang = a.thang and to_truong_pho = 1 and ma_vtcv = a.ma_vtcv)
	;
	----Lanh dao Phong
	update ttkd_bsc.dinhmuc_giao_dthu_ptm a
...
--					and exists(select * from ttkd_bsc.temp_021_ldp where ma_nv = a.ma_nv) 
	...
	update ttkd_bsc.dinhmuc_giao_dthu_ptm a
			set NHOMVINATS_KQTH = round(NHOMVINATS_KQTH * 0.8, 0)
	where a.thang = 202502 and ma_nv = 'VNP016950'
...
select * from
	...
	where thang = 202502 and ma_kpi in ('HCM_DT_PTMOI_021', 'HCM_DT_PTMOI_062', 'HCM_DT_PTMOI_065', 'HCM_DT_PTMOI_069')
				and ma_nv in ('VNP017813', 'VNP016950');ma_pb = 'VNP0701600'
	;
