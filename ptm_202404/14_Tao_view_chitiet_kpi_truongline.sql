...
CREATE OR REPLACE VIEW v_ct_ptm_kpi_truongline_202404 as
select thang_ptm, ma_nv,ma_to,ma_pb,ma_gd,ma_tb,dich_vu, ngay_sd,dthu_goi,dthu_goi_ngoaimang,tien_dnhm,tien_sodep
  ...
  from 
(select manv_ptm ma_nv,ma_to,(select ma_pb from ttkd_bsc.nhanvien_202404 where manv_hrm=a.manv_ptm) ma_pb
  ...
  from ct_bsc_ptm a
 where thang_tlkpi_to='202404' and (loaitb_id<>21 or ma_kh='GTGT rieng')
 
 
 union all 
select manv_ptm,ma_to,(select ma_pb from ttkd_bsc.nhanvien_202404 where manv_hrm=a.manv_ptm) ma_pb
       ,ma_gd,ma_tb,dich_vu,to_char(ngay_bbbg,'dd/mm/yyyy') ngay_sd,thang_ptm,dthu_goi,dthu_goi_ngoaimang,tien_dnhm,tien_sodep
       ,heso_dichvu,heso_dichvu_1,heso_dichvu_dnhm,heso_quydinh_nvptm,heso_quydinh_nvhotro,heso_diaban_tinhkhac, tyle_huongdt, heso_hoso
       ,tyle_hotro,manv_tt_dai
 ...
 union all 
select manv_tt_dai,ma_to_dai,(select ma_pb from ttkd_bsc.nhanvien_202404 where manv_hrm=a.manv_tt_dai) ma_pb,
        ma_gd,ma_tb,dich_vu,to_char(ngay_bbbg,'dd/mm/yyyy') ngay_sd,thang_ptm,dthu_goi,dthu_goi_ngoaimang,tien_dnhm,tien_sodep
       ,heso_dichvu,heso_dichvu_1,heso_dichvu_dnhm,heso_quydinh_nvptm,heso_quydinh_nvhotro,heso_diaban_tinhkhac, tyle_huongdt, heso_hoso
       ,tyle_hotro,manv_tt_dai
...
select manv_ptm ma_nv,ma_to,(select ma_pb from ttkd_bsc.nhanvien_202404 where manv_hrm=a.manv_ptm) ma_pb
  ...
  from ct_bsc_ptm a
 where thang_tlkpi_to='202404' and loaitb_id=21
