		...
		update ttkd_bsc.ct_bsc_ptm a set  thang_luong='3', heso_hoso=0.8
		    ...
		    where ((thang_ptm='202401' and (to_number(to_char(ngay_luuhs_ttkd,'yyyymmdd'))>20240313 or to_number(to_char(ngay_luuhs_ttvt,'yyyymmdd'))>20240313))
						or (thang_ptm='202402' and (to_number(to_char(ngay_luuhs_ttkd,'yyyymmdd'))>20240413 or to_number(to_char(ngay_luuhs_ttvt,'yyyymmdd'))>20240413)))
					  and (loaitb_id not in (21) or ma_kh='GTGT rieng') 
					  and mien_hsgoc is null and nop_du=1 and substr(bs_luukho,1,6)='202405' and heso_hoso is null		---thang n+1
