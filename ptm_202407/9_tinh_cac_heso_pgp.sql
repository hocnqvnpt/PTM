...
rollback;
commit;
select * from ttkd_bsc.ct_bsc_ptm_pgp where thang_tldg_dt_nvhotro = 202407; and heso_daily = 0.05;
select * from ttkd_bsc.ct_bsc_ptm_pgp where thang_ptm = 202407; and heso_daily = 0.05; and ma_tb in ('hcm_hddt_00013102', 'hcm_hddt_00023066', 'hcm_hddt_00007104')
...
--				   , b.manv_presale_hrm
    ...
    where thang_ptm = 202407 and manv_hotro is not null and (loaitb_id is null or loaitb_id<>21)			--thang n
...
--		select * from ttkd_bsc.ct_bsc_ptm_pgp a
			where exists (select * from ttkd_bsc.ct_bsc_ptm where ma_duan_banhang is not null and thang_tldg_dt_nvhotro = 202407 and a.ptm_id = id )
...
--											select * from ta where ma_yeucau in ('236617', '183656', '207081')
					...
					select --a.loaitb_id
					    ...
					    from ttkd_bsc.ct_bsc_ptm a
									left join tt b on to_number(regexp_replace (a.ma_duan_banhang, '\D', ''))  = b.ma_yeucau and a.loaitb_id = b.loaitb_id_obss
					    where thang_tldg_dt_nvhotro = 202407  and manv_hotro is not null and (loaitb_id is null or loaitb_id<>21)			--thang n
