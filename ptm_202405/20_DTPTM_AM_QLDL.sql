...
--update ttkd_bsc.dm_daily_khdn  set MANV_QLDAILY = 'CTV062104'
where thang=202405 and ma_daily in ('GTGT00185')
;
...
desc ttkd_bsc.dm_daily_khdn;
		...
		insert into ttkd_bsc.dm_daily_khdn (THANG, MA_DAILY, TEN_DAILY, MANV_QLDAILY, THANG_KYHD, LOAI_HOPDONG)		
					select 202405 thang, ma_nv  MA_DAILY, ten_nv TEN_DAILY, 'CTV077959' MANV_QLDAILY, 202405 THANG_KYHD, 'DAI LY MOI' LOAI_HOPDONG
		...
		update  ttkd_bsc.dm_daily_khdn 
			...
			where thang=202405 and ma_daily in ('GTGT00194')
		;
		---Dai  ly hien huu co ban moi
		update  ttkd_bsc.dm_daily_khdn 
			set thang_kyhd = thang, loai_hopdong = 'PHU LUC MOI', MANV_QLDAILY= 'VNP020233'
			where thang=202405 and ma_daily in ('GTGT00102')
		;
		---update maTo, PB, VTCV
		update ttkd_bsc.dm_daily_khdn 
			set (ma_to, ma_pb, ma_vtcv, ten_vtcv)= (select ma_to, ma_pb, ma_vtcv, ten_vtcv from ttkd_bsc.nhanvien where ma_nv = MANV_QLDAILY and thang = 202405)
			where thang=202405;
	commit;
	;
