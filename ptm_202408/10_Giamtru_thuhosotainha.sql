...
delete from ttkd_bsc.ct_giamtru where thang=202408
;
select * from ttkd_bsc.ct_giamtru where thang = 202408
;
insert into ttkd_bsc.ct_giamtru (ma_gd, thang, tien_giam, nguon_giam, ly_do, ma_nv, ma_to, ma_pb)
		    select ma_gd, 202408 thang, 15000 tien_giam, 'Luong don gia' nguon_giam, 
						 'Don gia thu ho so tai nha theo VB 746/TTr-NS 31/12/2019', manv_ptm, ma_to, ma_pb    
			   from ttkd_bsc.ct_bsc_ptm a
			   where kieuhd_id=2 and thang_tldg_dt = 202408 
