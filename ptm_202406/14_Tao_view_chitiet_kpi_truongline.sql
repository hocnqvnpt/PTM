select * from ttkd_bsc.v_ct_ptm_kpi_truongline_202406;
drop view ttkd_bsc.v_ct_ptm_kpi_truongline_202406;

CREATE OR REPLACE VIEW ttkd_bsc.v_ct_ptm_kpi_truongline_202406 as
...
(select manv_ptm ma_nv, ma_to, ma_pb
 ...
 where thang_tlkpi_to= 202406 and (loaitb_id<>21 or ma_kh='GTGT rieng')
...
select manv_ptm ma_nv,ma_to, ma_pb
  ...
  from ttkd_bsc.ct_bsc_ptm a
 where thang_tlkpi_to=202406 and loaitb_id=21
