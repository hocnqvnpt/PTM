...
--    update ttkd_bsc.dm_daily_khdn  set MANV_QLDAILY = 'CTV084801'
where thang=202406; and ma_daily in ('GTGT00128')
;
...
desc ttkd_bsc.dm_daily_khdn;
		...
		---update maTo, PB, VTCV
		update ttkd_bsc.dm_daily_khdn 
			set (ma_to, ma_pb, ma_vtcv, ten_vtcv)= (select ma_to, ma_pb, ma_vtcv, ten_vtcv from ttkd_bsc.nhanvien where ma_nv = MANV_QLDAILY and thang = 202406)
			where thang=202406;
	commit;
	;
