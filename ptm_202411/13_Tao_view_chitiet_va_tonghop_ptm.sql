-- nv ptm: xong
select * from ttkd_bsc.v_ct_bsc_ptm_202411;
select * from ttkd_bsc.v_bangluong_dongia_ptm_202411;
drop view ttkd_bsc.v_ct_bsc_ptm_202411;
create OR REPLACE VIEW ttkd_bsc.v_ct_bsc_ptm_202411 as
...
from ttkd_bsc.ct_bsc_ptm a
 where (loaitb_id not in (20,21) or (loaitb_id=20 and goi_luongtinh is null) or loaitb_id is null)
              and (thang_ptm between 202408 and 202411 or thang_tldg_dt = 202411)
		    and (thang_tldg_dt = 0 or nvl(thang_tldg_dt, 999999) >= 202411 or thang_tlkpi >= 202411 or thang_tlkpi_dnhm = 202411 
                              )
  ;      
  -- Ho tro cua Phong Giai phap:  xong
 drop view ttkd_bsc.v_ct_bsc_ptm_phongGP_202411;
 create OR REPLACE VIEW ttkd_bsc.v_ct_bsc_ptm_phongGP_202411 as
 select 
			   ...
			   (select ma_to from ttkd_bsc.nhanvien where thang = 202411 and manv_hrm=a.manv_hotro) ma_to,
			   (select ten_to from ttkd_bsc.nhanvien where thang = 202411 and  manv_hrm=a.manv_hotro) ten_to,
			   (select ma_pb from ttkd_bsc.nhanvien where thang = 202411 and  manv_hrm=a.manv_hotro) ma_pb,
			   (select ma_pb from ttkd_bsc.nhanvien where thang = 202411 and  manv_hrm=a.manv_hotro) ten_pb,
 ...
 where thang_ptm between 202408 and 202411
			and (nvl(thang_tldg_dt_nvhotro, 999999) >= 202411
					    or nvl(thang_tlkpi_hotro, 999999) >= 202411) 
              and exists (select 1 from ttkd_bsc.nhanvien where thang = 202411 and  ma_pb='VNP0702600' and ma_nv = a.manv_hotro)
		    ;
select * from ttkd_bsc.v_ct_bsc_ptm_phongGP_202411;
              

 -- View Tong hop bang luong don gia ptm:
drop view ttkd_bsc.v_bangluong_dongia_ptm_202411;
create OR REPLACE VIEW ttkd_bsc.v_bangluong_dongia_ptm_202411 as
