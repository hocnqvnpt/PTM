...
--											select * from ta where ma_yeucau in ('282078')
					...
					select --a.loaitb_id
					    ...
					    from ttkd_bsc.ct_bsc_ptm a
									left join tt b on to_number(regexp_replace (a.ma_duan_banhang, '\D', ''))  = b.ma_yeucau and a.loaitb_id = b.loaitb_id_obss
					    where (thang_tldg_dt_nvhotro = 202411 or thang_tlkpi_hotro = 202411)  and manv_hotro is not null and a.ma_duan_banhang is not null and (loaitb_id is null or loaitb_id<>21)			--thang n
