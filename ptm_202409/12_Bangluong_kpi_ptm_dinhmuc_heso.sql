...
--		  select * from ttkd_bsc.dinhmuc_giao_dthu_ptm a
			 where a.thang = 202408
							...
							and exists (select * from ttkd_bsc.blkpi_danhmuc_kpi_vtcv
												where ma_kpi in ('HCM_DT_PTMOI_021', 'HCM_DT_PTMOI_053') and thang = a.thang and to_truong_pho = 1 and ma_vtcv = a.ma_vtcv)
	;
	----Lanh dao Phong
	update ttkd_bsc.dinhmuc_giao_dthu_ptm a
...
--		  select * from ttkd_bsc.dinhmuc_giao_dthu_ptm a
		where  a.thang = 202408
					and exists (select * from ttkd_bsc.blkpi_danhmuc_kpi_vtcv
									where ma_kpi in ('HCM_DT_PTMOI_021', 'HCM_DT_PTMOI_053') and thang = a.thang and giamdoc_phogiamdoc = 1 and ma_vtcv=a.ma_vtcv)
	...
	where thang = 202408 and ma_nv in ('VNP016902',
'VNP017072',
'VNP017853',
'VNP017014',
'VNP016898',
...
select * from
	...
	where thang = 202408 and ma_kpi in ('HCM_TB_GIAHA_024', 'HCM_TB_GIAHA_026')
