-- nv ptm: xong
select * from ttkd_bsc.v_ct_bsc_ptm_202501;
select * from ttkd_bsc.v_bangluong_dongia_ptm_202501;
drop view ttkd_bsc.v_ct_bsc_ptm_202501;
create OR REPLACE VIEW ttkd_bsc.v_ct_bsc_ptm_202501 as
...
from ttkd_bsc.ct_bsc_ptm a
 where (loaitb_id not in (20,21) or (loaitb_id=20 and goi_luongtinh is null) or loaitb_id is null)
              and (thang_ptm between 202410 and 202501 or thang_tldg_dt = 202501)
		    and (thang_tldg_dt = 0 or nvl(thang_tldg_dt, 999999) >= 202501 or thang_tlkpi >= 202501 or thang_tlkpi_dnhm = 202501 
                              )
  ;      
  -- Ho tro cua Phong Giai phap:  xong
 drop view ttkd_bsc.v_ct_bsc_ptm_phongGP_202501;
 create OR REPLACE VIEW ttkd_bsc.v_ct_bsc_ptm_phongGP_202501 as
 select 
			   ...
			   (select ma_to from ttkd_bsc.nhanvien where thang = 202501 and manv_hrm=a.manv_hotro) ma_to,
			   (select ten_to from ttkd_bsc.nhanvien where thang = 202501 and  manv_hrm=a.manv_hotro) ten_to,
			   (select ma_pb from ttkd_bsc.nhanvien where thang = 202501 and  manv_hrm=a.manv_hotro) ma_pb,
			   (select ma_pb from ttkd_bsc.nhanvien where thang = 202501 and  manv_hrm=a.manv_hotro) ten_pb,
 ...
 where (thang_ptm between 202410 and 202501 or thang_tldg_dt_nvhotro = 202501)
			and (nvl(thang_tldg_dt_nvhotro, 999999) >= 202501
					    or nvl(thang_tlkpi_hotro, 999999) >= 202501) 
              and exists (select 1 from ttkd_bsc.nhanvien where thang = 202501 and  ma_pb='VNP0702600' and ma_nv = a.manv_hotro)
		    ;
select * from ttkd_bsc.v_ct_bsc_ptm_phongGP_202501;
              

 -- View Tong hop bang luong don gia ptm:
drop view ttkd_bsc.v_bangluong_dongia_ptm_202501;
create OR REPLACE VIEW ttkd_bsc.v_bangluong_dongia_ptm_202501 as
